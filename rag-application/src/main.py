        ...
        with st.spinner("Running RAGAS Evaluation... Please wait."):
            try:
                ...
                for question in eval_questions:
                    ...
                    response = client.chat.completions.create(messages=full_prompt, model="llama3-70b-8192")
...
if prompt := st.chat_input("e.g., 'Compare the display quality of the iPhone 15 Pro and Galaxy S24 Ultra'"):
    ...
    with st.spinner("Thinking..."):
        ...
        prompt_messages = [
            {"role": "system", "content": "You are a helpful product comparison assistant. Use the provided context and conversation history to answer the user's query precisely. If the context does not contain the answer, say that you don't have enough information."},
            {"role": "user", "content": f"Context:\n{retrieved_context_str}\n\nQuestion:\n{prompt}"}
        ]
